      ...
      <div className="bloco">
        <div id="linha1" style={{ display: "flex" }}>
          <div>
            <input
              id="FA"
              className="campo_preenchimento CondSaude"
              type="checkbox"
            />
        ...
        <div id="linha5" style={{ display: "flex" }}>
          <div>
            ...
            <input
              ...
              className="campo_preenchimento"
              type="text"
              placeholder="Se sim, por qual causa."
            />
          </div>
          <div>
            ...
            />
            <input
              id="PlantasMedicinais"
              list="browsers"
              className="campo_preenchimento"
              placeholder="Se sim, indique qual(is)"
            />
        ...
        <div id="linha7" style={{ display: "flex" }}>
          <div>
            ...
            <input
              ...
              list="browsers"
              className="campo_preenchimento"
              placeholder="Insuficiência Renal"
            />
            <datalist id="browsers">
          ...
          <div id="linha5" style={{ display: "flex" }}>
            <div>
              ...
              <input
                ...
                className="campo_preenchimento"
                type="text"
                placeholder="Indique o grau de parentesco"
              />
            </div>
            <div>
