    ...
    <div className="background">
        <div id="termo de recusa">
            ...
            <div  style={{display:'flex'}} className="bloco" >
                <div style={{display:'flex'}}>
                    ...
                    , gozando de plena consciência dos meus atos, recuso este cadastro, mesmo que isso facilite o acompanhamento da minha saúde e de meus familiares. Estou ciente de que esta recusa não implicará no não atendimento da unidade de Saúde.</p>
                </div>
                <div>
        ...
        <div>
            ...
            <div  style={{display:'flex'}} className="bloco" >
                ...
                portador(a) do RG nº
                <input id="NomeCidadao" className="campo_preenchimento" type="text" placeholder="Número do RG"/>
                , responsável técnico pela Instituição, recuso este cadastro mesmo que esta recusa dificulte o acompanhamento da saúde das pessoas abrigadas/residentes nesta Instituição. Estou ciente de que esta recusa não implicará no não atendimento da unidade de Saúde.</p>
            </div>
            <div>
                <h3 className='titulosSecoes'>Assinatura</h3>
                <canvas id="board"></canvas>
